...
|-----------|--------|-------|
| **Core Specification** | v1.5.0 Stable | [Spec](https://promptpack.org/docs/spec/overview) |
...
**Built by [AltairaLabs](https://altairalabs.ai) for the conversational AI community.**
